...
{
    // start datatables
    var $column_order = array(null, 'barcode', 'p_item.name', 'unit_name', 'price', 'stock'); //set column field database for datatable orderable
    ...
    public function get($id = null, $barcode = null)
    {
        $this->db->select('p_item.*, p_unit.name as unit_name');
        $this->db->from('p_item');
