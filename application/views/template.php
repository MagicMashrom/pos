...
<head>
  ...
  <!-- <link rel="stylesheet" href="<?php echo base_url() . 'assets/autocomplete/css/bootstrap.css' ?>"> -->
...
<body class="hold-transition skin-blue sidebar-mini <?= $this->uri->segment(1) == 'sale' ? 'sidebar-collapse' : null ?>">
              ...
              <ul class="treeview-menu">
                ...
                <?php if ($this->session->userdata('level') == 1 || $this->session->userdata('level') == 3) { ?>
                  ...
                  <li <?= $this->uri->segment(1) == 'stock' && $this->uri->segment(2) == 'return' ? 'class="active"' : '' ?>>
                    <a href="<?= site_url('stock/return') ?>"><i class="fa fa-circle-o"></i> Return</a>
                  </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <ul class="treeview-menu">
              ...
              <?php if ($this->session->userdata('level') == 1 || $this->session->userdata('level') == 3) { ?>
                ...
                <li <?= $this->uri->segment(1) == 'laporan' && $this->uri->segment(2) == 'stock_out' ? 'class="active"' : '' ?>>
                  <a href="<?= site_url('laporan/stock_out') ?>"><i class="fa fa-circle-o"></i> Stock Out / Opname</a>
                </li>
                <li <?= $this->uri->segment(1) == 'laporan' && $this->uri->segment(2) == 'stock_return' ? 'class="active"' : '' ?>>
                  <a href="<?= site_url('laporan/stock_return') ?>"><i class="fa fa-circle-o"></i> Return</a>
                </li>
            </ul>
          </li>
        <?php } ?>
  ...
  <script type="text/javascript">
    window.siteku = 'http://localhost/pos/';

    $(document).ready(function() {
      $(".scanbarcode").keyup(function() {
        var panjanginput = $(this).val().length;
