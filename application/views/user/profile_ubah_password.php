...
<section class="content">
    <div class="box">
        <div class="box-header ">
             <h3 class="box-title">Edit Passwoed</h3>
            <div class="pull-right">
                <a href="<?=site_url('user/profile')?>" class="btn btn-primary btn-flat">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <form action="" method="post">
                        <div class="form-group <?= form_error('fullname') ? 'has-error' : null ?>">
                            ...
                            <input type="hidden" name="fullname" value="<?=$this->input->post('fullname') ?? $row->name ?>" class="form-control">
                        </div>
                        ...
                        <div class="form-group <?= form_error('address') ? 'has-error' : null ?>">
                            ...
                            <?= form_error('address') ?>
                            <textarea name="address" type="hidden"  class="form-control"><?=$this->input->post('address') ?? $row->address ?></textarea>
                        </div>
