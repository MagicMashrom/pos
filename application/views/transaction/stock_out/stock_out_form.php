     ...
     <div class="box">
         <div class="box-header ">
             ...
             <div class="pull-right">
                 <a href="<?= site_url("stock/out") ?>" class="btn btn-primary btn-flat">
             ...
             <div class="row">
                 <div class="col-md-4 col-md-offset-4">
                     <form action="<?= site_url('stock/process') ?>" class="formsb" method="post">
                         <input type="hidden" class="arahpost" value="stock/out/add" />
                         ...
                         <div class="form-group">
                             <button type="sumbit" name="out_add" class="btn btn-success btn-flat">Save</button>
