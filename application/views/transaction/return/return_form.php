     ...
     <div class="box">
         <div class="box-header ">
             ...
             <div class="pull-right">
                 <a href="<?= site_url("stock/return") ?>" class="btn btn-primary btn-flat">
             ...
             <div class="row">
                 <div class="col-md-4 col-md-offset-4">
                     <form action="<?= site_url('stock/process') ?>" class="formsb" method="post">
                         <input type="hidden" class="arahpost" value="stock/return/add" />
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" name="detail" id="detail" placeholder="Rusak / Hilang / Kadaluwarsa / etc" class="form-control">
                         </div>
                         <div class="form-group">
                             <label for="">Qty *</label>
                         ...
                         <div class="form-group">
                             <button type="sumbit" name="return_add" class="btn btn-success btn-flat">Save</button>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header">
                 ...
                 <h4 class="modal-tittle">Selec Product Item</h4>
             </div>
                     ...
                     <tbody>
                         <?php foreach ($item as $i => $data) { ?>
                             <tr>
                                 ...
                                 <td class="text-right"><?= indoCurrency($data->price) ?></td>
