...
$route['stock/return'] = 'stock/stock_return_data';
$route['stock/return/add'] = 'stock/stock_return_add';
$route['stock/return/del/(:num)/(:num)'] = 'stock/stock_return_del';

$route['laporan/stock_in'] = 'laporan/laporan_stock_in';
$route['laporan/stock_out'] = 'laporan/laporan_stock_out';
$route['laporan/stock_return'] = 'laporan/laporan_stock_return';
